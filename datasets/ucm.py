...
base_classes = ['sparseresidential', 'buildings', 'agricultural', 'chaparral', 'harbor', 'tenniscourt',
                'parkinglot',  'river', 'runway', 'beach', 'overpass',  'airplane' ,'denseresidential',
                'mobilehomepark', 'baseballdiamond','forest',]

novel_classes = ['golfcourse', 'freeway', 'intersection',  'mediumresidential', 'storagetanks', ]
